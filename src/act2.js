...
export function createAct2Play(root) {
  ...
  // A star by fiat: someone who truly delivers between 1.5x and 4x their résumé.
  $('a2star').addEventListener('click', () => { cand = 1.5 + 2.5 * rng(); noises = []; revealed = true; dirty = true; sync(); });
